...
The tree's entropy is the weighted sum of the entropies of its leaf nodes (Figure 2); the entropy of a leaf node is the weighted sum of the self-informations (in Shannons) of all possible outcomes (Figure 1).
