...
Steps 3 and 4 are used to dynamize $m_{ij}$ and $s_{ij}$ in the beginning of training, since they are initialized at 0. Notice that these steps do virtually nothing after a few dozen iterations.